...
def get_part1_list():
    ...
    """
    numbers = [num**2 for num in range(100)] # TODO: Change this line to be a list comprehension
...
def get_part2_list():
    ...
    """
    numbers = [num for num in range(100) if num % 5 == 0 or num % 7 == 0] # TODO: Change this line to be a list comprehension
...
def get_part3_list():
    ...
    new_words = [word for word in old_words if 'e' in word and len(word) >= 4] # TODO: Change this line to be a list comprehension
